...
-   [数据迁移/同步/订阅的工作原理是什么？](#section_ygj_70v_7mu)
-   [DTS支持哪些数据库的迁移/同步/订阅？](#section_n4q_38f_qxm)
-   [数据迁移和数据同步的区别是什么？](#section_8yo_tqz_gwl)
-   [是否支持跨云账号的数据迁移/同步？](#section_3qu_2jx_itv)
...
-   [是否支持DML/DDL操作的同步？](#section_icj_d5d_pvf)
-   [DTS是否支持分库分表的数据迁移/同步？](#section_ipd_ru6_sbz)
-   [DTS是否支持跨时区/字符集的数据迁移/同步？](#section_zk8_h10_gye)
-   [是否支持更改数据迁移/同步的对象在目标库中的名称？](#section_8ud_rx7_tlh)
-   [是否支持过滤部分字段或数据？](#section_79e_b54_nr9)
-   [数据同步是否支持新增/移除同步对象？](#section_7s5_yc6_27v)
-   [如何查看数据迁移/同步的性能信息？](#section_1kk_pik_p30)
-   [同步延迟的计算规则是什么？](#section_ag8_doq_sq7)
-   [如何配置延迟告警及阀值？](#section_cj7_ul6_r8w)
...
## 为什么数据同步的价格普遍高于数据迁移？ {#section_k32_hxn_llm .section}
...
## 是否支持同一实例内的数据迁移？ {#section_xsb_ru0_zcj .section}
...
详情请参见[查看增量迁移性能](../../../../cn.zh-CN/用户指南/数据迁移/查看增量迁移性能.md#)或[查看同步性能](../../../../cn.zh-CN/用户指南/实时同步/查看同步性能.md#)。
